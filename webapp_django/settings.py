...
SECRET_KEY = 'django-insecure-+@k5=2y2kd(wnif3d5%rit_u3v3hvaofqfo%$^394=&d^3nvwk'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',  # ⚠️ Use PostgreSQL in production
...
# Whitenoise compressed storage (better performance)
